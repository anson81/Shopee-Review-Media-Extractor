...
(function (root, factory) {
  ...
  function createZip(entries) {
    ...
    for (const entry of entries) {
      ...
      const declared = Number(entry.data && entry.data.length) || 0;
      if (declared > U32_MAX) {
    ...
    sink.u16(0);
    sink.u16(0);
    sink.u16(needsZip64End ? U16_MAX : count);
    sink.u16(needsZip64End ? U16_MAX : count);
    sink.u32(needsZip64End ? U32_MAX : centralSize);
    sink.u32(needsZip64End ? U32_MAX : centralStart);
    sink.u16(0);
